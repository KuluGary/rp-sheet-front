...
const Help = () => {
  return (
    <div className="mt-20 flex flex-col items-center gap-4">
      <NavBar />
      <Sheet>
        <Checkbox name="text" checked={true} style={{ width: "30px" }} />
        <section className="px-6 py-9">
          ...
          <p className="my-4">
            ...
            adecuados. Te recomendamos que hagas este proceso conjuntamente con el/los libros del sistema de rol que
            hayas elegido.
          </p>
          ...
          <p className="my-4">
            ...
            modificados manualmente a menos que sepas lo que estás haciendo o hayas trabajado previamente con archivos
            en formato JSON.
          </p>
          <h3 className="font-bold text-lg">Cargar tu ficha</h3>
          <p className="my-4">
            Si quieres modificar una ficha que ya tienes guardada en formato <code>.json</code> o continuar desde donde
            lo dejaste, lo puedes hacer a través del botón <FileUpload size={28} color={"black"} /> en la barra de
          ...
          <p className="my-4">
            Por defecto, las fichas de personaje contienen un número de páginas distinto dependiendo del sistema de
      ...
      <Sheet>
        <section className="px-6 py-9">
          <p className="my-4">
            ...
            personaje. Mediante el botón <FileAdd size={28} color={"black"} /> de la barra de navegación, abrirás un
            menú que te permitirá añadir una página adicional si está disponible dependiendo del sistema de juego. De
            este tipo de página puedes incluir tantas como creas convenientes, y todos se guardarán una vez finalices tu
            ficha.
          </p>
          ...
          <p className="my-4">
            ...
            En ese caso, en el pie de página de cada una de tus páginas podrás ver un número que determina en qué
            posición se halla la página (1, 2, 3...).
          </p>
          <p className="my-4">
            Los valores en este pie de página son editables y te permiten cambiar la posición entre dos páginas. Si vas
            al pie de página de la página 1 y lo modificas para que en su lugar sea el número 2, la antigua segunda
            página pasará a ser la nueva primera página, y la antigua primera página tomará su lugar.
          </p>
